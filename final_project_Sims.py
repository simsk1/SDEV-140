...
protein.grid(row=5, column=10) #, columnspan=250)
fat.grid(row=7, column=10) #, columnspan=300)
cho.grid(row=9, column=10) #, columnspan=120)
...
root.mainloop() #seems like this needs to be the last line of code to work properly
